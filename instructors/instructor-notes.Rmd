...
**Hyper-Threading** technology is a form of [simultaneous-multithreading](#simultaneous-multithreading) technology introduced by Intel.
...
### Symmetric Multiprocessing (SMP) {#symmetric-multiprocessing}
...
### Simultaneous multithreading (SMT) {#simultaneous-multithreading}
...
A **worker node** is a node in a cluster that performs assigned computational tasks as part of a distributed system, typically under the coordination of a scheduler or master node.
