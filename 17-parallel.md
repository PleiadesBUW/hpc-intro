...
which should take 30.000 seconds with 0.850 parallel proportion of the workload.
  ...
  Hello, World! I am process 0 of 1 on fugg11. I will do all the serial 'work' for 4.500 seconds.
  Hello, World! I am process 0 of 1 on fugg11. I will do parallel 'work' for 25.500 seconds.
...
```bash
[user@fugg1 ~]$ for n in 30.033 10.888 7.697; do python3 -c "print(30.033 / $n)"; done
```
