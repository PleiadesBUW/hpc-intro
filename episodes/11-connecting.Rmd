...
address of the remote machine. In general, the `hostname` appears as
`r config$remote$login` or sometimes just as `r config$remote$host`.
...
shell application with a Unix-like command line interface on your system.
